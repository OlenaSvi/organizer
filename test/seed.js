...
globalThis.T = {
  ...
  seed: function () {
    ...
    /* Справочники набора — свои, а не приложения: иначе смена стартовых
       сфер ломает половину проверок по причине, к делу не относящейся. */
    S.spheres = ["Быт", "мама", "Йони", "бюрократия", "развитие",
                 "здоровье физическое", "здоровье ментальное", "другое"];
    S.places = ["Амстердам", "Кипр", "Израиль"];
    S.people = ["Мама", "Я", "Йони", "Нитай"];
    S.items = [
